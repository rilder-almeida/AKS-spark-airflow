az aks stop --name $TF_VAR_cluster_name --resource-group $TF_VAR_rg_name --yes --no-wait
...
az group delete --resource-group MC_${TF_VAR_rg_name}_${TF_VAR_cluster_name} --yes --no-wait
